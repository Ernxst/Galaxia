...
export default defineComponent({
  ...
  props: {
    modelValue: Object as PropType<CelestialBodyData>,
  ...
  setup(props) {
    ...
    const isAsteroid = computed(() => props.type !== 'asteroid belt');
    ...
    const attributes = [
      ...
      },
      {
        name: "dayLength",
        min: 0,
        max: isAsteroid.value ? 1_000_000 : 10,
        step: isAsteroid.value ? 1 : 0.01,
        relative: !isAsteroid.value,
        show: true,
